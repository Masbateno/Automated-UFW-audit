"""Tests for ufw_audit.exposure — real exposure view."""
...
from ufw_audit.exposure import ExposureItem, compute_exposure
from ufw_audit.scoring import FindingLevel, Finding
