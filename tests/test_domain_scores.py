"""
Tests for ufw_audit/domain_scores.py  (Phase B1)
...
from ufw_audit.scoring import CheckResult, ScoreEngine
...
class TestRenderDomainScores:
    ...
    def test_contains_all_domain_labels(self):
        from ufw_audit.domain_scores import _LABELS
        scores = compute_domain_scores(_clean_engine())
...
class TestDiffCLI:
    ...
    def test_diff_domain_scores_in_webhook_payload(self):
        ...
        from ufw_audit.webhook import build_generic_payload
