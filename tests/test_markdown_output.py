"""
Tests for ufw_audit/markdown_output.py — --output markdown.
...
from ufw_audit.markdown_output import build_markdown_output, _md_escape
...
class TestMarkdownStructure:
    def test_starts_with_h1(self):
        ...
        assert md.startswith("# ufw-audit Report")
