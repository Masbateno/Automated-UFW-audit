...
from ufw_audit.checks.ssl_certs import (
    CertEntry,
    SslCertsSnapshot,
    _add_path,
...
class TestCollectFromConfigs:
    def test_extracts_nginx_cert(self, tmp_path):
        import re
        from ufw_audit.checks.ssl_certs import _NGINX_SSL_RE
    ...
    def test_extracts_apache_cert(self, tmp_path):
        from ufw_audit.checks.ssl_certs import _APACHE_SSL_RE
...
class TestReadCertExpiry:
    ...
    def test_large_file_skipped(self, tmp_path):
        ...
        from ufw_audit.checks.ssl_certs import _MAX_CERT_SIZE
...
class TestSslCertsFromSystem:
    def test_no_openssl_returns_empty_snap(self):
        with patch("ufw_audit.checks.ssl_certs._command_exists", return_value=False):
    ...
    def test_discovers_letsencrypt_certs(self, tmp_path):
        ...
        stdout = "notAfter=Apr 19 00:00:00 2099\n"
        with (
            patch("ufw_audit.checks.ssl_certs._command_exists", return_value=True),
            patch("ufw_audit.checks.ssl_certs.Path") as mock_path_cls,
        ...
        import ufw_audit.checks.ssl_certs as mod
        orig = mod.Path
    ...
    def test_max_certs_limit_respected(self, tmp_path):
        ...
        from ufw_audit.checks.ssl_certs import _MAX_CERTS
        import ufw_audit.checks.ssl_certs as mod
