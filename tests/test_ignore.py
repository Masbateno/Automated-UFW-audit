"""Tests for ufw_audit.ignore — ignore.yml load/add logic."""
...
from ufw_audit.ignore import load_ignore_keys, add_ignore_key
from ufw_audit.cli import parse_args, AuditConfig
...
class TestScoreEngineIgnoreKeys:
    ...
    def test_finding_without_key_not_ignored(self):
        from ufw_audit.scoring import ScoreEngine, CheckResult
        engine = ScoreEngine()
        engine.ignore_keys = frozenset({"ssh.permit_root_login"})
        r = CheckResult()
