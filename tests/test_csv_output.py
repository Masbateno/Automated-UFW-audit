"""
Tests for ufw_audit/csv_output.py — CSV export.
...
def _make_engine(score: int = 7, alerts: int = 1, warnings: int = 2):
    ...
    """
    from ufw_audit.scoring import MAX_SCORE, Deduction, FindingLevel, ScoreEngine, Finding
    engine = ScoreEngine()
...
class TestCSVHeaders:
    def test_header_present(self):
        from ufw_audit.csv_output import build_csv_output, _HEADERS
        engine = _make_engine()
