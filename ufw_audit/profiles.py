"""
Audit profile system for ufw-audit.
...
Built-in profiles are shipped as .conf files under ufw_audit/data/profiles/.
User-defined profiles can be placed in ~/.config/ufw-audit/profiles/.
...
Usage
-----
    from ufw_audit.profiles import load_profile, apply_profile
...
_USER_PROFILES_DIR    = Path.home() / ".config" / "ufw-audit" / "profiles"
