"""
Watch mode for ufw-audit (--watch[=N]).
...
Usage:
    sudo ufw-audit --watch        # default 60s interval
    sudo ufw-audit --watch=30     # custom interval in seconds
"""
...
from ufw_audit.runner import run_checks
...
if TYPE_CHECKING:
    ...
    from ufw_audit.profiles import AuditProfile
