"""
Markdown audit report module for ufw-audit.
...
Usage:
    from ufw_audit.report_markdown import MarkdownReport
...
class MarkdownReport:
    ...
    def open(cls, directory: Path, version: str) -> "MarkdownReport":
        ...
        Args:
            ...
            version:   ufw-audit version string (e.g. "0.12.0").
...
def send_audit_log_as_html_email(
    ...
    Args:
        ...
        recipient: Email address to send to.
        subject:   Email subject. If empty, defaults to "UFW-AUDIT Report".
